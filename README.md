...
- Writing my new static site generator platform, [cppaper](https://github.com/Yrds/cppaper)
  - C++20, inja, EnTT, cmark.
- Sometimes in my very very free time, I like to make games.

#### [AUR](https://aur.archlinux.org/) repositories

- [blender-lts-bin](https://aur.archlinux.org/packages/blender-lts-bin)
- [cppaper](https://aur.archlinux.org/packages/cppaper) 
